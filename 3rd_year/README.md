...
|-|-|-|-|-|-|-|
|09.09|[Введение. NLP Pipeline.](Slides/1-intro.pdf)|4.09| [NLP Pipeline. Базовый пайплайн работы с текстом. Создания простого спеллчекера с помощью NLTK, векторов и рассстояния Левенштейна (нерешённый)](seminars/sem1_pipeline_clean.ipynb)||
